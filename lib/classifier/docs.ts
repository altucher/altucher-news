/**
 * The documentation, as plain text with UPPERCASE headings. `curl /api/classify`
 * prints it as-is; the /classify page renders the same document, so the two
...
export const API_PATH = '/api/classify'

export const docs = (origin: string) => `classifier
